...
This project is indexed by GitNexus as **context-mode** (10214 symbols, 18723 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/context-mode/context` | Codebase overview, check index freshness |
| `gitnexus://repo/context-mode/clusters` | All functional areas |
| `gitnexus://repo/context-mode/processes` | All execution flows |
| `gitnexus://repo/context-mode/process/{name}` | Step-by-step execution trace |
